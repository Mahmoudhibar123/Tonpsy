                    ...
                    <div className="therapists-content pt-5 pb-2">
                        <div className="container py-5 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="250" height="250" viewBox="0 0 172 172">
                                <g fill="none" fill-rule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none">
                            ...
                            <div>
                                <h2 className="py-4">Your Payment is successfull.</h2>
                                <p>You can now chat with your Therapist by Using Chat Button present with your booking history.</p>
                                <div className="form-group blue-blob pt-2 text-center">
                                    <a href="/mybookings" type="button" className="btn btn-primary green-btn">Go My Booking</a>
                                </div>
                            </div>
                        </div>
                    </div>
